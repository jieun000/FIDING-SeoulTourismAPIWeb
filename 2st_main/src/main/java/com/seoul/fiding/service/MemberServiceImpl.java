...
public class MemberServiceImpl implements MemberService{
	...
	public List<BoardVO> selectToplike(SearchVO vo) {
		List<BoardVO> bvoList=mapper.selectToplike(vo);
		bvoList.forEach(bvo->bvo.setAddress(mapper.selectOneTour(bvo.getTL_NO()).getAddress()));
		bvoList.forEach(bvo->bvo.setUrl(mapper.selectOneTour(bvo.getTL_NO()).getUrl()));
		return bvoList;
	}
   ...
   public TourVO selectOneTour(int TL_NO) {
	...
	public int selectBoardPaging9l(SearchVO vo) {
		return mapper.selectBoardPaging9l(vo);
	}
	@Override
	public int selectBoardByIdPaging9l(SearchVO vo) {
		return mapper.selectBoardByIdPaging9l(vo);
	}
	@Override
	public int selectBoardByFavorPaging9l(SearchVO vo) {
		return mapper.selectBoardByFavorPaging9l(vo);
	}
	@Override
	public int selectBoardBySearchPaging9l(SearchVO vo) {
		return mapper.selectBoardBySearchPaging9l(vo);
	}
	@Override
	public int selectToplikePaging9l(SearchVO vo) {
		return mapper.selectToplikePaging9l(vo);
	}
