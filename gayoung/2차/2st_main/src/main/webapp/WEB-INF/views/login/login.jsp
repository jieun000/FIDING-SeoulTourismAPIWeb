...
<head>
	...
	<meta name ="google-signin-client_id" content="952427883399-ctiaq0d2gvlnhhc8vq5blpprbukoh9m2.apps.googleusercontent.com"><!-- 구글 클라이언트 아이디 -->
<!--===============================================================================================-->	
						...
						<ul>
 							<li id="GgCustomLogin">
  								<a href="javascript:void(0)">
  									<span>
  										<!-- 구글 로고 이미지 추가 -->
   										<img src="/resources/images/google_medium.png" alt="구글 로그인">
									</span>
  								</a>
 							</li>
						</ul>
...
<!--===============================================================================================-->
	...
	function onSignIn(googleUser) {
		...
		$.ajax({
			...
			, data: {personFields:'birthdays', key:'AIzaSyBqWfGlPl-z0pgkb2OyuxFy0Vc5xGlxrNc', 'access_token': access_token}
			, method:'GET'
		})
		.done(function(e){
	        //프로필을 가져온다.
