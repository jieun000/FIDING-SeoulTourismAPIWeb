			...
			<form action="/trip/writeBoard" method="POST">
				<div class="feed_2">    
					<div class="feed_update">
			        	...
			        	<div><label for="content">본문 : </label><textarea cols="7" class="updateInput" id="content" placeholder="본문" name="content"></textarea></div>
			        	<div><label for="tag">태그 : </label><input type="text" class="updateInput" id="tag" placeholder="태그" name="tag" /></div>
