...
<div class="main-content" id="main-content">
	<div class="main_body">
		<div class="board_wrap">
					...
					<div class="carousel-container">
						<div class="carousel-inner">
							<div class="feed_picture carousel-item" >
								<img src="/resources/SampleImg/picture7.png" class="gallery-image" alt="피드 사진 1" style="height:1000px; width: 600px;">
							</div>
							<div class="feed_picture carousel-item">
			...
			<!--/feedbottom-->
			<form action="/trip/boardUpdate" method="POST">
				<div class="feed_2">    
					<div class="feed_update">
			        	<div><label for="BD_NO">게시글 번호 : </label><input type="text" class="updateInput" id="BD_NO" value="${boardVO.BD_NO}" name="BD_NO"/></div>
				     	<div><input type="hidden" class="updateInput" id="TL_NO" placeholder="관광지 번호" name="TB_NO" readonly /></div>
				     	<div><input type="hidden" class="updateInput" id="id" placeholder="게시판 아이디" name="id" readonly/></div>
				     	<div><input type="hidden" class="updateInput" id="nickname" placeholder="게시판 닉네임" name="nickname" readonly/></div>
				     	<div><label for="like_cnt">좋아요 : </label><input type="text" class="updateInput" id="like_cnt" placeholder="좋아요 수" name="like_cnt" readonly value="${boardVO.like_cnt}"/></div>
				        <div><label for="cat">카테고리 : </label><input type="text" class="updateInput" id="cat" placeholder="카테고리" name="cat" readonly value="${boardVO.cat}"/></div>
						<div><label for="title">제목 : </label><input type="text" class="updateInput" id="title" placeholder="제목" name="title" value="${boardVO.title}"/></div>
			        	<div><label for="content">본문 : </label><textarea cols="7" class="updateInput" id="content" placeholder="본문" name="content">${boardVO.content}</textarea></div>
			        	<div><label for="tag">태그 : </label><input type="text" class="updateInput" id="tag" placeholder="태그" name="tag" value="${boardVO.tag}"/></div>
