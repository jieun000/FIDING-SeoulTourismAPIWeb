...
<div class="main-content" id="main-content">
   <div class="main_body">
      <div class="board_wrap">
         ...
         <div class="feed">${boardVO.content}</div>
...
<script>
   ...
   function handleCancel() {
    ...
    // 수정 버튼 클릭 이벤트에 handledelete 함수 연결
    $('#update_button').click(handleDelete);

    // 취소 버튼 클릭 이벤트에 deleteCancel 함수 연결
    $('#cancel_button').click(deleteCancel);
