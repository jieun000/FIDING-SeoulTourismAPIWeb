            ...
            <div class="feed_2">    
               <div class="feed_update">
                  ...
                  <div><label for="title">제목 : </label><input type="text" class="updateInput" id="title" placeholder="제목" name="title" value="${boardVO.title}"/></div>
                    <div class="verticalU"><label class="labelU" for="content">본문 : </label><textarea cols="7" class="updateInput" id="content" placeholder="본문" name="content">${boardVO.content}</textarea></div>
                    <div><label for="tag">태그 : </label><input type="text" class="updateInput" id="tag" placeholder="#태그 #태그 #태그" name="tag" value="${boardVO.tag}"/></div>
