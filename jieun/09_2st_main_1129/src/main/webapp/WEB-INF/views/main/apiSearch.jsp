					  ...
					  console.log("요청 성공", data);
				        ...
				        r.click(function(e){
				            ...
				            var categoryMappings = [
				                { cateCode: /^A01/, category: "자연" },
				                { cateCode: /^A0201/, category: "역사" },
				                { cateCode: /^A0202/, category: "관광" },
				                { cateCode: /^A0207/, category: "축제" },
				                { cateCode: /^A05/, category: "음식" }
				            ];
				            categoryMappings.some(mapping => {
				                if (mapping.cateCode.test(cat)) {
