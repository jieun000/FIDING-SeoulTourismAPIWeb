        ...
        <div className="container-login100">
          <div className="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
            ...
            <div className="wrap-input100 validate-input m-b-23" data-validate="Password is required">
              ...
              <input className="input100" type="password" name="pw" placeholder="비밀번호는 입력해주세요"/>
              <span className="focus-input100" data-symbol="&#xf190;"></span>
            </div>
            ...
            <div className="wrap-input100 validate-input m-b-23" data-validate="phonenumber is reauired">
                ...
                <input className="input100" type="text" name="phone" placeholder="010-0000-0000" oninput="formatPhoneNumber(this)"/>
                <span className="focus-input100" data-symbol="&#xf206;"></span>
            </div>
